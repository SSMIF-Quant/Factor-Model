...
VALUATION_DATA_PATH_WIN: str = 'C:\\Users\\miked\\git\\Factor-Model\\data_processing\\clean_data\\valuation_data.csv' # f"{ROOT_DIR}\\{CLEAN_DATA_FOLDER}\\valuation_data.csv"
MACROECONOMIC_DATA_PATH_WIN: str = 'C:\\Users\\miked\\git\\Factor-Model\\data_processing\\clean_data\\macroeconomic_data.csv' # f"{ROOT_DIR}\\{CLEAN_DATA_FOLDER}\\macroeconomic_data.csv"
SENTIMENT_DATA_PATH_WIN: str = 'C:\\Users\\miked\\git\\Factor-Model\\data_processing\\clean_data\\sentiment_data.csv' # f"{ROOT_DIR}\\{CLEAN_DATA_FOLDER}\\sentiment_data.csv"
